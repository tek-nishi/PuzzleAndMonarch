* TODO 全体的な画面の明るさやパネルの色味を調整する
* TODO 小さいバッファにレンダリングして引き延ばす実験
* TODO チュートリアルの文字が邪魔
* TODO チュートリアルまだ街が登場していないのに「道で繋いで得点」が表示された
* TODO 雲がなるべく均等に配置されるように
* TODO 回転操作時の処理負荷を減らす
* TODO シェーダーの計算量を減らす(vec4→vec3)
* TODO チュートリアル発動中はパネルの出現順序を固定する
* TODO ランキング→タイトルでのGameのリセットを無くしたい
